<div wire:ignore.self class="modal fade" id="modalTicket" data-backdrop="static" tabindex="-1" role="dialog"
            ...
            <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select wire:model="rent_tarifa" class="form-control text-primary">
                            ...
                            <option value="{{$t->tar_id}}" class="form-control"> {{$t->tar_valor}} {{$t->tar_tiempo}} *
                                S/ {{$t->tar_precio}}
